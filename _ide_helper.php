...
namespace App\Facades { 
    ...
    class RssFacade {
         ...
         * @static 
         */ 
        public static function make($feed_url = array(), $limit = 0, $force_feed = false)
        {
            return \App\Utility\RssUtility::make($feed_url, $limit, $force_feed);
        }
...
namespace  { 
    ...
    class Rss extends \App\Facades\RssFacade {}
